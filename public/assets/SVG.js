export const cloudSun =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-cloud-sun" viewBox="0 0 16 16">
...
export const cloudRainy =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-cloud-drizzle" viewBox="0 0 16 16">
...
export const cloudSnow =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-cloud-snow" viewBox="0 0 16 16">
...
export const cloudLight =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-cloud-lightning" viewBox="0 0 16 16">
...
export const cloudClear =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-cloud-check" viewBox="0 0 16 16">
...
export const cloudDbl =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-clouds" viewBox="0 0 16 16">
...
export const cloudHaze =
    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="currentColor" className="bi bi-cloud-haze2" viewBox="0 0 16 16">
